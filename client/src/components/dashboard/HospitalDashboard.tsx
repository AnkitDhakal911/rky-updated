...
export const HospitalDashboard = ({ user }: { user: UserType }) => {
    ...
    const [filterRange, setFilterRange] = useState(50);
    ...
    const fetchHospitalData = async () => {
        try {
            ...
            // Filter unfulfilled and Apply Local Blood Type Filter (for myReqs which might not be filtered by API if I didn't pass it there or for completeness)
            let filtered = allReqs.filter((r: any) => r.status !== 'Fulfilled');
            
            if (filterBloodType !== 'All') {
                filtered = filtered.filter((r: any) => r.bloodType === filterBloodType);
            }
        ...
        <div className="max-w-[1600px] mx-auto space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="grid lg:grid-cols-12 gap-10 px-4">
                ...
                <div className="lg:col-span-8 xl:col-span-9 space-y-8">
                    ...
                    {/* Filter Bar */}
                    <div className="bg-white/50 backdrop-blur-md rounded-[40px] p-6 border border-white/50 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
                        <div className="flex flex-col gap-3 w-full md:w-auto">
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">Mission Filter</p>
                        ...
                        <div className="flex flex-col gap-3 w-full md:min-w-[300px]">
                            <div className="flex justify-between items-center ml-2">
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Radar Radius</p>
